...
class LocationService {
  ...
  Future<String> calculateDistanceAndTime(
    ...
    try {
      ...
      final deliveryLocation =
          await watchLocationById(deliveryLocationId).first;

      if (pickupLocation == null ||
          deliveryLocation == null ||
          !pickupLocation.hasCoordinates ||
          !deliveryLocation.hasCoordinates) {
        return 'n/a • n/a';
      }
  ...
  Future<List<Location>> findNearestLocations(Location targetLocation,
      {int limit = 5}) async {
